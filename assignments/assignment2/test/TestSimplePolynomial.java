...
public class TestSimplePolynomial {
  ...
  public void testToStringWithNegativeBeginning() {
    simplePolynomialUnderTest.addTerm(4, 1);
    simplePolynomialUnderTest.addTerm(2, 5);
    simplePolynomialUnderTest.addTerm(-3, 2);
    simplePolynomialUnderTest.addTerm(-10, 0);

    assertEquals("2x^5-3x^2+4x^1-10", simplePolynomialUnderTest.toString());
  }
