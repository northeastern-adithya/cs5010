...
public class Book {
  ...
  /**
   * Construct a cs5010.hw01.publication.
   * Book object that has the provided title, author and  price.
   *
   ...
   *
   * @return the author of this object as a @link{cs5010.hw01.publication.Person}
   */
