...
/**
 * Test to check the LoggingSeparateDecorator class.
 */
public class LoggingSeparatePillCounterTest {

  @Test
  public void usage() {
    PillCounter counter = new LoggingSeparateDecorator(
            new PillBatchAddCounter(new LoggingPillCounter()),
            new LoggingImplementation());
