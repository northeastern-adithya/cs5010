 ...
 * These operations are supposed to be a barebones set upon which other
 * operations
 * may be developed.
 */
public interface SpreadSheet {
   ...
   * @return the number at the specified cell, as a double. If the cell is
   *         empty, it returns a 0
  ...
  /**
   * Return the height of this spreadsheet. The height is defined by the cell
   * with
